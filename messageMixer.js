...
MessageMixer.countCharacter = function(inputString, inputCharacter) {
  ...
  MessageMixer.pigLatin = function(strSentence, chrCharacter) {
    return this.replaceAllOccurrences(strSentence,' ', chrCharacter + ' ');
  }
  

//module.exports works when others fail 20210220 cdunsford
//module.exports = MessageMixer;

//export doesn't work without adding and modifying package.json
